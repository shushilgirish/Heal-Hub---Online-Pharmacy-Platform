//frontend/src/components/Header3.jsx
    ...
    <Navbar bg="light" variant="light" className="p-3">
      <Container>
        ...
        <Nav className="me-auto mb-2 mb-lg-0">
          <Nav.Link as={Link} to="/admin" className="px-2 text-black">
            Home
          </Nav.Link>
          <Nav.Link as={Link} to="./addproduct" className="px-2 text-black">
            Add Product
          </Nav.Link>
          <Nav.Link as={Link} to="./manageuser" className="px-2 text-black">
            Manage Users
          </Nav.Link>
          <Nav.Link as={Link} to="./manageproduct" className="px-2 text-black">
            Manage Products
          </Nav.Link>
          <Nav.Link as={Link} to="./paymenthistory" className="px-2 text-black">
            Payment History
          </Nav.Link>
        </Nav>
